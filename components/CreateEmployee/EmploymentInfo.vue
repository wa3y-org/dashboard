<template>
  <div class="px-4 mt-4">
    <v-row>
      ...
      <v-col>
        <TextField :errors="validationErrors.employmentPosition" v-model="employee.employment_position" name="Position" placeholder="Enter employee position" />
      </v-col>
    </v-row>
    <v-row>
      <v-col>
        <w-select-qualification v-model="employee.qualification" />
      </v-col>
      <v-col>
        <text-field v-model="employee.specialization" name="specialization" placeholder="Enter employee specialization" />
      </v-col>
    </v-row>
    <v-row>
      <v-col>
        <DatePicker v-model="employee.starting_date" name="Started At" />
      </v-col>
      <v-col>
