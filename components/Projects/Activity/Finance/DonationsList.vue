...
async function loadDonations() {
  loading.start();
  const response = await useActivityFinance().getDonations(props.activity)
  loading.end();
...
onMounted(() => {
  loadDonations();
  useNuxtApp().$activeModalsBus.$on('activities:finance:created', loadDonations)
  useNuxtApp().$activeModalsBus.$on('activities:finance:updated', loadDonations)
  useNuxtApp().$activeModalsBus.$on('activities:finance:removed', loadDonations)
