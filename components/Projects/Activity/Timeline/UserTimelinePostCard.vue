<template>
  ...
  <v-timeline-item size="large" align-start>
    <template v-slot:icon>
      <div v-if="creator">
        <v-avatar size="large" :image="avatar"></v-avatar>
      </div>
    </template>
    ...
    <p class="px-4 py-2 font-weight-bold text-grey">
      {{ creator.name }} , 
    ...
    <ProjectsActivityTimelineListReplies :post="post" />
