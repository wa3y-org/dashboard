...
onMounted(() => {
  loadDonations();
  useNuxtApp().$activeModalsBus.$on('projects:finance:created', loadDonations)
  useNuxtApp().$activeModalsBus.$on('projects:finance:updated', loadDonations)
  useNuxtApp().$activeModalsBus.$on('projects:finance:removed', loadDonations)
