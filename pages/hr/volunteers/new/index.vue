...
import { createVolunteer } from "~/app/modules/volunteers/create";
const step = ref(1);
const items = [
...
const volunteer: Ref<VolunteersRecord & VolunteersResponse> = ref({
  name: '',
  address: '',
  avatar: null,
  birth_date: null,
...
async function save() {
  ...
  loading.start()
  const record = await createVolunteer(volunteer.value);
  loading.end();
